...
}(this, (function ()
{
    ...
    let T = 1;
    const O = {mouseenter: "mouseover", mouseleave: "mouseout"}, C = /^(mouseenter|mouseleave)/i, k = new Set([
        "click",
        "dblclick",
        "mouseup",
        "mousedown",
    ...
    const R = (t, e = "hide") =>
    {
        ...
        j.on(document, i, `[data-bs-dismiss="${s}"]`, (function (i)
        {
            if ([
                "A",
                "AREA"
            ].includes(this.tagName) && i.preventDefault(), c(this))
            {
                return;
            }
    ...
    var mt = "top", gt = "bottom", _t = "right", bt = "left", vt = "auto", yt = [
            ...
            _t,
            bt
        ], wt = "start", Et = "end", At = "clippingParents", Tt = "viewport", Ot = "popper", Ct = "reference",
        ...
        jt = "beforeWrite", Mt = "write", Ht = "afterWrite", Bt = [
            xt,
            Dt,
            St,
            Nt,
        ...
        return i && ("html" === Rt(i) || "body" === Rt(i) && "static" === Yt(i).position) ? e : i || function (t)
        {
            ...
            ].indexOf(Rt(i)) < 0;)
            {
                ...
                if ("none" !== n.transform || "none" !== n.perspective || "paint" === n.contain || -1 !== [
                    "transform",
                    "perspective"
                ].indexOf(n.willChange) || e && "filter" === n.willChange || e && n.filter && "none" !== n.filter)
                {
                    return i;
                }
                i = i.parentNode
    ...
    const Fe = Object.freeze({
        ...
        ri = m() ? "left-start" : "right-start", ai = m() ? "right-start" : "left-start", li = {
            offset: [
                0,
                2
            ], boundary: "clippingParents", reference: "toggle", display: "dynamic", popperConfig: null, autoClose: !0
        }, ci = {
    ...
    j.on(document, "click.bs.offcanvas.data-api", '[data-bs-toggle="offcanvas"]', (function (t)
    {
        ...
        if ([
            "A",
            "AREA"
        ].includes(this.tagName) && t.preventDefault(), c(this))
        {
            return;
        }
        j.one(e, qi, (() =>
    ...
    class xn extends B
    {
        ...
        show()
        {
            ...
            if (j.trigger(this._element, "show.bs.tab", {relatedTarget: t}).defaultPrevented || null !== s && s.defaultPrevented)
            {
                return;
            }
