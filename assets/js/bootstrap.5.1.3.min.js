...
}(this, (function (t)
{
    ...
    let L = 1;
    const S = {mouseenter: "mouseover", mouseleave: "mouseout"}, O = /^(mouseenter|mouseleave)/i, N = new Set([
        "click",
        "dblclick",
        "mouseup",
        "mousedown",
    ...
    const F = (t, e = "hide") =>
    {
        ...
        $.on(document, i, `[data-bs-dismiss="${s}"]`, (function (i)
        {
            if ([
                "A",
                "AREA"
            ].includes(this.tagName) && i.preventDefault(), u(this))
            {
                return;
            }
    ...
    class at extends R
    {
        ...
        _slide(t, e)
        {
            ...
            {
                s.classList.remove(ot), o.classList.add(ot), this._isSliding = !1, u();
            }
            a && this.cycle()
        }
    ...
    class Ht extends R
    {
        ...
        _getConfig(t)
        {
            if (t = {...this.constructor.Default, ...X.getDataAttributes(this._element), ...t}, h(bt, t, this.constructor.DefaultType), "object" == typeof t.reference && !l(t.reference) && "function" != typeof t.reference.getBoundingClientRect)
            {
    ...
    $.on(document, "click.bs.offcanvas.data-api", '[data-bs-toggle="offcanvas"]', (function (t)
    {
        ...
        if ([
            "A",
            "AREA"
        ].includes(this.tagName) && t.preventDefault(), u(this))
        {
            return;
        }
        $.one(e, pe, (() =>
